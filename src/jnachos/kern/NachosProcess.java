...
public class NachosProcess implements Runnable {
	...
	public HashMap<Integer,BufferEntry> processQueue;
	
	private  Queue<Integer> mQueue;

	public  Queue<Integer> getmQueue() {
		return mQueue;
	}

	public  void setmQueue(Queue<Integer> mQueue) {
		this.mQueue = mQueue;
	}
	...
	public NachosProcess(String pProcessName) {
		...
		String[] array1=mName.split("/");
		
		actualName=array1[array1.length-1];
		
		//System.out.println(" Inside NachosProcess:.. "+actualName);
		...
		processQueue=new HashMap <Integer,BufferEntry> ();
	...
	public HashMap<Integer, BufferEntry> getProcessQueue() {
		return processQueue;
	}


	public void setProcessQueue(HashMap<Integer, BufferEntry> processQueue) {
