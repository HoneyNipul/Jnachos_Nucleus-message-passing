...
public abstract class JNachos {
	...
	public static BufferEntry[] bufferPool  ;
	
	public static HashMap<String,NachosProcess> processPool;
	...
	public static void initialize(String args[]) {
		...
		double rely = 1;
		 ...
		 bufferPool= new BufferEntry[10];
		 initializeBufferPool(bufferPool);
		...
		processPool = new HashMap<String, NachosProcess>();
	...
	public static HashMap<String, NachosProcess> getProcessPool() {
		return processPool;
	}

	public static void setProcessPool(HashMap<String, NachosProcess> processPool) {
		JNachos.processPool = processPool;
	}
	...
	/** initilizing the bufferEntries of the bufferPool **/
	private static void initializeBufferPool(BufferEntry[] bufferPool) {
		for(int i=0;i<bufferPool.length;i++)
		{
			
			bufferPool[i] = new BufferEntry();
			bufferPool[i].setId(i);
			bufferPool[i].setAvailable(true);
		}
